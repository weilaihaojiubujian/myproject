...
<!--                </el-form-item>-->
<!--                <el-form-item>-->
<!--                    &lt;!&ndash;                    <el-button type="primary" v-on:click="getUsers">查询</el-button>&ndash;&gt;-->
...
<!--                    &lt;!&ndash;                    <el-input type="file" ref="clearFile" @change="getFile($event)" multiple="multiplt" class="add-file-right-input"  ></el-input>&ndash;&gt;-->
<!--                    <a>只支持doc,docx</a><br />-->
<!--                </el-form-item>-->
...
<!--            },-->
<!--            otherUserInfo(params,index, row) {-->
<!--                this.project.id=params.row.id;-->
<!--                console.log(this.project.id);-->
<!--                this.$router.push({ name:'其他用户信息', params:{id:this.project.id}});-->
<!--            },-->
